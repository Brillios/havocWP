...
// Classes.
$wrap_classes = array( 'products', 'havocwp-row', 'clr' );

// List/grid style.
if ( ( (function_exists( 'havocwp_is_woo_shop' ) && havocwp_is_woo_shop()) || (function_exists( 'havocwp_is_woo_tax' ) && havocwp_is_woo_tax()) )
	&& get_theme_mod( 'havoc_woo_grid_list', true )
	&& 'list' === get_theme_mod( 'havoc_woo_catalog_view', 'grid' ) ) {
	$wrap_classes[] = 'list';
} else {
	$wrap_classes[] = 'grid';
}
...
// Responsive columns.
$tablet_columns = get_theme_mod( 'havoc_woocommerce_tablet_shop_columns' );
$mobile_columns = get_theme_mod( 'havoc_woocommerce_mobile_shop_columns' );
