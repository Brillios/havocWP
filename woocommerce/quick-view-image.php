...
<div class="hvc-qv-image flexslider images">
	<ul class="hvc-qv-slides slides">
		<?php
		...
		if ( has_post_thumbnail() ) {
			...
			echo sprintf( '<li><img src="%s" alt="%s" /></li>', wc_placeholder_img_src(), __( 'Placeholder', 'havocwp' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		}
		?>
	</ul>
</div>
