...
// Get elements.
$elements = havocwp_woo_product_elements_positioning();
...
foreach ( $elements as $element ) {
	...
	if ( 'image' === $element ) {
		...
		if ( class_exists( 'HavocWP_WooCommerce_Config' ) ) {
			HavocWP_WooCommerce_Config::loop_product_thumbnail();
		}
	...
	if ( 'button' === $element ) {
		...
		do_action( 'havoc_before_archive_product_add_to_cart' );
		...
		do_action( 'havoc_after_archive_product_add_to_cart' );
