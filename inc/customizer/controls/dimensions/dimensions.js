var $ = jQuery;
wp.customize.controlConstructor['havocwp-dimensions'] = wp.customize.Control.extend({
...
$( document ).on( 'click', '.havocwp-linked',  function() {
...
// Unlinked button
$( document ).on( 'click', '.havocwp-unlinked',  function() {
