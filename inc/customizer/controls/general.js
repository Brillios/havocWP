jQuery(document).on('havocready', function() {
	...
	$( '.customize-control .responsive-switchers button:not(.havoc-proccessed)' ).on( 'click', function( event ) {
	...
	$( '.wp-full-overlay-footer .devices button:not(.havoc-proccessed)' ).on( 'click', function( event ) {
