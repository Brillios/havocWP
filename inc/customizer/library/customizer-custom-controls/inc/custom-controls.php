...
if ( class_exists( 'WP_Customize_Control' ) && class_exists( 'WP_Customize_Section' ) ) {
	 ...
	 * @author Brillios
	 */
	class HavocWP_Custom_Control extends WP_Customize_Control {
	 ...
	 * @author Brillios
	 */
	class HavocWP_Custom_Section extends WP_Customize_Section {
		protected function get_skyrocket_resource_url() {
			if ( strpos( wp_normalize_path( __DIR__ ), wp_normalize_path( WP_PLUGIN_DIR ) ) === 0 ) {
				// We're in a plugin directory and need to determine the url accordingly.
				return plugin_dir_url( __DIR__ );
	 ...
	 * @author Brillios
	 */
	class HavocWP_Image_Checkbox_Custom_Control extends HavocWP_Custom_Control {
		/**
		...
		public function enqueue() {
			wp_enqueue_style( 'skyrocket-custom-controls-css', HAVOCWP_INC_DIR_URI . 'customizer/assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
	 ...
	 * @author Brillios
	 */
	class HavocWP_Customizer_Buttonset_Control extends HavocWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @author Brillios
	 */
	class HavocWP_Customizer_Radio_Image_Control extends HavocWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @author Brillios
	 */
	class HavocWP_Single_Accordion_Custom_Control extends HavocWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-custom-controls-js', HAVOCWP_INC_DIR_URI . 'customizer/assets/js/customizer.js', array( 'jquery' ), '1.0', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', HAVOCWP_INC_DIR_URI . 'customizer/assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @author Brillios
	 */
	class HavocWP_Simple_Notice_Custom_Control extends HavocWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @author Brillios
	 */
	class HavocWP_Customizer_Range_Control extends HavocWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-custom-controls-js', HAVOCWP_INC_DIR_URI . 'customizer/assets/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.0', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', HAVOCWP_INC_DIR_URI . 'customizer/assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
		...
		public function render_content() {
			?>
			<div class="slider-custom-control control-wrap customize-control-havocwp-slider">
				<span class="customize-control-title"><?php echo esc_html( $this->label ); ?></span>
				...
				<div class="slider havocwp-slider" slider-min-value="<?php echo ow_esc_attr( @$this->input_attrs['min'] ); ?>" slider-max-value="<?php echo ow_esc_attr( @$this->input_attrs['max'] ); ?>" slider-step-value="<?php echo ow_esc_attr( @$this->input_attrs['step'] ); ?>"></div>
			</div>
			<?php
		}
	}
	 ...
	 * @author Brillios
	 */
	class HavocWP_Toggle_Switch_Custom_control extends HavocWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @author Brillios
	 */
	class HavocWP_Sortable_Repeater_Custom_Control extends HavocWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @author Brillios
	 */
	class HavocWP_Dropdown_Select2_Custom_Control extends HavocWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-select2-js', HAVOCWP_INC_DIR_URI . 'customizer/assets/js/select2.full.min.js', array( 'jquery' ), '4.0.13', true );
			wp_enqueue_script( 'skyrocket-custom-controls-js', HAVOCWP_INC_DIR_URI . 'customizer/assets/js/customizer.js', array( 'skyrocket-select2-js' ), '1.0', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', HAVOCWP_INC_DIR_URI . 'customizer/assets/css/customizer.css', array(), '1.1', 'all' );
			wp_enqueue_style( 'skyrocket-select2-css', HAVOCWP_INC_DIR_URI . 'customizer/assets/css/select2.min.css', array(), '4.0.13', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @author Brillios
	 */
	class HavocWP_Dropdown_Posts_Custom_Control extends HavocWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @author Brillios
	 */
	class HavocWP_TinyMCE_Custom_control extends HavocWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @author Brillios
	 */
	class HavocWP_Google_Font_Select_Custom_Control extends HavocWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function render_content() {
			...
			if ( ! empty( $this->fontList ) ) {
				...
				<div class="google_fonts_select_control">
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight & style for regular text', 'havocwp' ); ?></div>
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight for', 'havocwp' ); ?> <italic><?php esc_html_e( 'italic text', 'havocwp' ); ?></italic></div>
					<div class="weight-style">
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight for', 'havocwp' ); ?> <strong><?php esc_html_e( 'bold text', 'havocwp' ); ?></strong></div>
					<div class="weight-style">
		...
		public function skyrocket_getGoogleFonts( $count = 30 ) {
			...
			$fontFile = HAVOCWP_INC_DIR_URI . 'customizer/assets/inc/google-fonts-alphabetical.json';
			if ( $this->fontOrderBy === 'popular' ) {
				$fontFile = HAVOCWP_INC_DIR_URI . 'customizer/assets/inc/google-fonts-popularity.json';
			}
	 ...
	 */
	class HavocWP_Customizer_Color_Control extends HavocWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'skyrocket-custom-controls-js', HAVOCWP_INC_DIR_URI . 'customizer/assets/js/customizer.js', array( 'jquery', 'wp-color-picker' ), '1.0', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', HAVOCWP_INC_DIR_URI . 'customizer/assets/css/customizer.css', array( 'wp-color-picker' ), '1.0', 'all' );
			wp_localize_script( 'skyrocket-custom-controls-js', 'havocwpLocalize', array( 'colorPalettes' => havocwp_default_color_palettes() ) );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 */
	class HavocWP_Alpha_Color_Control extends HavocWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue() {
			wp_enqueue_style( 'skyrocket-custom-controls-css', HAVOCWP_INC_DIR_URI . 'customizer/assets/css/customizer.css', array(), '1.0', 'all' );
			wp_enqueue_script( 'wp-color-picker-alpha', HAVOCWP_INC_DIR_URI . 'customizer/assets/js/wp-color-picker-alpha-min.js', array( 'wp-color-picker' ), '1.0', true );
			wp_enqueue_style( 'wp-color-picker' );
		}
		/**
	 ...
	 * @author Brillios
	 */
	class HavocWP_Customize_Multicheck_Control extends HavocWP_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			if ( isset( $this->input_attrs['fullwidth'] ) && $this->input_attrs['fullwidth'] ) {
				 ...
				 */
		public function enqueue() {
			wp_enqueue_script( 'skyrocket-custom-controls-js', HAVOCWP_INC_DIR_URI . 'customizer/assets/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.1', true );
			wp_enqueue_style( 'skyrocket-custom-controls-css', HAVOCWP_INC_DIR_URI . 'customizer/assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @author Brillios
	 */
	class HavocWP_Upsell_Section extends HavocWP_Custom_Section {
		/**
		 * The type of control being rendered
		 */
