    ...
    wp.customize.bind('ready', function() {
        ...
        api.section.each( function( section ) {
            section.container.bind( 'expanded', function() {
                ...
                if ( added ) {
                    jQuery( document ).trigger('havocready');
                }
            } )
        } )
        ...
        wp.customize.previewer.bind('url',function(to) {
            localStorage.setItem( 'HavocCustomizePreviewUrl', to );
        })

        if ( localStorage.getItem( 'HavocCustomizePreviewUrl' ) ) {
            wp.customize.previewer.previewUrl( localStorage.getItem( 'HavocCustomizePreviewUrl' ) );
            localStorage.removeItem( 'HavocCustomizePreviewUrl' );
        }
    })
