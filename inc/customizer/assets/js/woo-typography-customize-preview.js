    ...
    api("woo_single_notice_typography[font-family]", function ($swipe) {
        $swipe.bind(function (pair) {
            ...
            if (pair) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-single-notice-font-family">.woocommerce div.hvc-woo-single-cond-notice span, .woocommerce div.hvc-woo-single-cond-notice a{font-family: ' +
                    pair +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_notice_typography[font-weight]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-single-notice-font-weight">.woocommerce div.hvc-woo-single-cond-notice span, .woocommerce div.hvc-woo-single-cond-notice a{font-weight: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_notice_typography[font-style]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-single-notice-font-style">.woocommerce div.hvc-woo-single-cond-notice span, .woocommerce div.hvc-woo-single-cond-notice a{font-style: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_notice_typography[font-size]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-single-notice-font-size">.woocommerce div.hvc-woo-single-cond-notice span, .woocommerce div.hvc-woo-single-cond-notice a{font-size: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_notice_tablet_typography[font-size]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_single_notice-tablet-font-size">@media (max-width: 768px){.woocommerce div.hvc-woo-single-cond-notice span, .woocommerce div.hvc-woo-single-cond-notice a{font-size: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_notice_mobile_typography[font-size]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_single_notice-mobile-font-size">@media (max-width: 480px){.woocommerce div.hvc-woo-single-cond-notice span, .woocommerce div.hvc-woo-single-cond-notice a{font-size: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_notice_typography[line-height]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-single-notice-line-height">.woocommerce div.hvc-woo-single-cond-notice span, .woocommerce div.hvc-woo-single-cond-notice a{line-height: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_notice_tablet_typography[line-height]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_single_notice-tablet-line-height">@media (max-width: 768px){.woocommerce div.hvc-woo-single-cond-notice span, .woocommerce div.hvc-woo-single-cond-notice a{line-height: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_notice_mobile_typography[line-height]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_single_notice-mobile-line-height">@media (max-width: 480px){.woocommerce div.hvc-woo-single-cond-notice span, .woocommerce div.hvc-woo-single-cond-notice a{line-height: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_notice_typography[letter-spacing]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-single-notice-letter-spacing">.woocommerce div.hvc-woo-single-cond-notice span, .woocommerce div.hvc-woo-single-cond-notice a{letter-spacing: ' +
                    dataAndEvents +
                    "px;}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_notice_tablet_typography[letter-spacing]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_single_notice-tablet-letter-spacing">@media (max-width: 768px){.woocommerce div.hvc-woo-single-cond-notice span, .woocommerce div.hvc-woo-single-cond-notice a{letter-spacing: ' +
                    dataAndEvents +
                    "px;}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_notice_mobile_typography[letter-spacing]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_single_notice-mobile-letter-spacing">@media (max-width: 480px){.woocommerce div.hvc-woo-single-cond-notice span, .woocommerce div.hvc-woo-single-cond-notice a{letter-spacing: ' +
                    dataAndEvents +
                    "px;}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_notice_typography[text-transform]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-single-notice-text-transform">.woocommerce div.hvc-woo-single-cond-notice span, .woocommerce div.hvc-woo-single-cond-notice a{text-transform: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_add_to_cart_typography[font-family]", function ($swipe) {
        $swipe.bind(function (pair) {
            ...
            if (pair) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-single-add-to-cart-font-family">.woocommerce .hvc-btn-normal .summary form button.button, .woocommerce .hvc-btn-big .summary form button.button, .woocommerce .hvc-btn-very-big .summary form button.button{font-family: ' +
                    pair +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_add_to_cart_typography[font-weight]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-single-add-to-cart-font-weight">.woocommerce .hvc-btn-normal .summary form button.button, .woocommerce .hvc-btn-big .summary form button.button, .woocommerce .hvc-btn-very-big .summary form button.button{font-weight: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_add_to_cart_typography[font-style]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-single-add-to-cart-font-style">.woocommerce .hvc-btn-normal .summary form button.button, .woocommerce .hvc-btn-big .summary form button.button, .woocommerce .hvc-btn-very-big .summary form button.button{font-style: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_add_to_cart_typography[font-size]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-single-add-to-cart-font-size">.woocommerce .hvc-btn-normal .summary form button.button, .woocommerce .hvc-btn-big .summary form button.button, .woocommerce .hvc-btn-very-big .summary form button.button{font-size: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_add_to_cart_tablet_typography[font-size]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_single_add_to_cart-tablet-font-size">@media (max-width: 768px){.woocommerce .hvc-btn-normal .summary form button.button, .woocommerce .hvc-btn-big .summary form button.button, .woocommerce .hvc-btn-very-big .summary form button.button{font-size: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_add_to_cart_mobile_typography[font-size]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_single_add_to_cart-mobile-font-size">@media (max-width: 480px){.woocommerce .hvc-btn-normal .summary form button.button, .woocommerce .hvc-btn-big .summary form button.button, .woocommerce .hvc-btn-very-big .summary form button.button{font-size: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_add_to_cart_typography[line-height]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-single-add-to-cart-line-height">.woocommerce .hvc-btn-normal .summary form button.button, .woocommerce .hvc-btn-big .summary form button.button, .woocommerce .hvc-btn-very-big .summary form button.button{line-height: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_add_to_cart_tablet_typography[line-height]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_single_add_to_cart-tablet-line-height">@media (max-width: 768px){.woocommerce .hvc-btn-normal .summary form button.button, .woocommerce .hvc-btn-big .summary form button.button, .woocommerce .hvc-btn-very-big .summary form button.button{line-height: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_add_to_cart_mobile_typography[line-height]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_single_add_to_cart-mobile-line-height">@media (max-width: 480px){.woocommerce .hvc-btn-normal .summary form button.button, .woocommerce .hvc-btn-big .summary form button.button, .woocommerce .hvc-btn-very-big .summary form button.button{line-height: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_add_to_cart_typography[letter-spacing]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-single-add-to-cart-letter-spacing">.woocommerce .hvc-btn-normal .summary form button.button, .woocommerce .hvc-btn-big .summary form button.button, .woocommerce .hvc-btn-very-big .summary form button.button{letter-spacing: ' +
                    dataAndEvents +
                    "px;}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_add_to_cart_tablet_typography[letter-spacing]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_single_add_to_cart-tablet-letter-spacing">@media (max-width: 768px){.woocommerce .hvc-btn-normal .summary form button.button, .woocommerce .hvc-btn-big .summary form button.button, .woocommerce .hvc-btn-very-big .summary form button.button{letter-spacing: ' +
                    dataAndEvents +
                    "px;}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_add_to_cart_mobile_typography[letter-spacing]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_single_add_to_cart-mobile-letter-spacing">@media (max-width: 480px){.woocommerce .hvc-btn-normal .summary form button.button, .woocommerce .hvc-btn-big .summary form button.button, .woocommerce .hvc-btn-very-big .summary form button.button{letter-spacing: ' +
                    dataAndEvents +
                    "px;}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_single_add_to_cart_typography[text-transform]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-single-add-to-cart-text-transform">.woocommerce .hvc-btn-normal .summary form button.button, .woocommerce .hvc-btn-big .summary form button.button, .woocommerce .hvc-btn-very-big .summary form button.button{text-transform: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_archive_notice_typography[font-family]", function ($swipe) {
        $swipe.bind(function (pair) {
            ...
            if (pair) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-archive-notice-font-family">.woocommerce ul.products li.hvc-woo-cond-notice span, .woocommerce ul.products li.hvc-woo-cond-notice a{font-family: ' +
                    pair +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_archive_notice_typography[font-weight]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-archive-notice-font-weight">.woocommerce ul.products li.hvc-woo-cond-notice span, .woocommerce ul.products li.hvc-woo-cond-notice a{font-weight: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_archive_notice_typography[font-style]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-archive-notice-font-style">.woocommerce ul.products li.hvc-woo-cond-notice span, .woocommerce ul.products li.hvc-woo-cond-notice a{font-style: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_archive_notice_typography[font-size]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-archive-notice-font-size">.woocommerce ul.products li.hvc-woo-cond-notice span, .woocommerce ul.products li.hvc-woo-cond-notice a{font-size: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_archive_notice_tablet_typography[font-size]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_archive_notice-tablet-font-size">@media (max-width: 768px){.woocommerce ul.products li.hvc-woo-cond-notice span, .woocommerce ul.products li.hvc-woo-cond-notice a{font-size: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_archive_notice_mobile_typography[font-size]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_archive_notice-mobile-font-size">@media (max-width: 480px){.woocommerce ul.products li.hvc-woo-cond-notice span, .woocommerce ul.products li.hvc-woo-cond-notice a{font-size: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_archive_notice_typography[line-height]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-archive-notice-line-height">.woocommerce ul.products li.hvc-woo-cond-notice span, .woocommerce ul.products li.hvc-woo-cond-notice a{line-height: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_archive_notice_tablet_typography[line-height]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_archive_notice-tablet-line-height">@media (max-width: 768px){.woocommerce ul.products li.hvc-woo-cond-notice span, .woocommerce ul.products li.hvc-woo-cond-notice a{line-height: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_archive_notice_mobile_typography[line-height]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_archive_notice-mobile-line-height">@media (max-width: 480px){.woocommerce ul.products li.hvc-woo-cond-notice span, .woocommerce ul.products li.hvc-woo-cond-notice a{line-height: ' +
                    dataAndEvents +
                    ";}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_archive_notice_typography[letter-spacing]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-archive-notice-letter-spacing">.woocommerce ul.products li.hvc-woo-cond-notice span, .woocommerce ul.products li.hvc-woo-cond-notice a{letter-spacing: ' +
                    dataAndEvents +
                    "px;}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_archive_notice_tablet_typography[letter-spacing]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_archive_notice-tablet-letter-spacing">@media (max-width: 768px){.woocommerce ul.products li.hvc-woo-cond-notice span, .woocommerce ul.products li.hvc-woo-cond-notice a{letter-spacing: ' +
                    dataAndEvents +
                    "px;}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_archive_notice_mobile_typography[letter-spacing]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-woo_archive_notice-mobile-letter-spacing">@media (max-width: 480px){.woocommerce ul.products li.hvc-woo-cond-notice span, .woocommerce ul.products li.hvc-woo-cond-notice a{letter-spacing: ' +
                    dataAndEvents +
                    "px;}}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
    ...
    api("woo_archive_notice_typography[text-transform]", function ($swipe) {
        $swipe.bind(function (dataAndEvents) {
            ...
            if (dataAndEvents) {
                /** @type {string} */
                var img =
                    '<style class="customizer-typography-archive-notice-text-transform">.woocommerce ul.products li.hvc-woo-cond-notice span, .woocommerce ul.products li.hvc-woo-cond-notice a{text-transform: ' +
                    dataAndEvents +
                    ";}</style>";
                if ($child.length) {
                    $child.replaceWith(img);
