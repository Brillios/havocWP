...
if ( ! class_exists( 'HavocWP_LearnDash_Customizer' ) ) :

	/**
	 * Settings for general options
	 */
	class HavocWP_LearnDash_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			 ...
			 * Panel
			 */
			$panel = 'havoc_ld_panel';
			$wp_customize->add_panel(
				$panel,
				array(
					'title'    => esc_html__( 'LearnDash', 'havocwp' ),
					'priority' => 210,
				)
			);
			 ...
			 */
			$wp_customize->add_setting(
				'havoc_ld_distraction_free_learning',
				array(
					'default'           => false,
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'     => 'checkbox',
						'section'  => 'havoc_ld_general',
						'settings' => 'havoc_ld_distraction_free_learning',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new HavocWP_Customizer_Radio_Image_Control(
					...
					array(
						...
						'section'  => 'havoc_ld_layout',
						'settings' => 'havoc_ld_global_layout',
						'priority' => 10,
			 ...
			 */
			$wp_customize->add_setting(
				'havoc_ld_global_both_sidebars_style',
				array(
					'default'           => 'scs-style',
					'sanitize_callback' => 'havocwp_sanitize_select',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'select',
						'section'         => 'havoc_ld_layout',
						'settings'        => 'havoc_ld_global_both_sidebars_style',
						'priority'        => 10,
						'choices'         => array(
						...
						'active_callback' => 'havocwp_cac_has_ld_global_bs_layout',
					)
				)
			);
			 ...
			 */
			$wp_customize->add_setting(
				'havoc_ld_global_both_sidebars_content_width',
				array(
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'number',
						'section'         => 'havoc_ld_layout',
						'settings'        => 'havoc_ld_global_both_sidebars_content_width',
						'priority'        => 10,
						'input_attrs'     => array(
							'min'  => 0,
							'max'  => 100,
			 ...
			 */
			$wp_customize->add_setting(
				'havoc_ld_global_both_sidebars_sidebars_width',
				array(
					'transport'         => 'postMessage',
					'sanitize_callback' => 'havocwp_sanitize_number_blank',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'number',
						'section'         => 'havoc_ld_layout',
						'settings'        => 'havoc_ld_global_both_sidebars_sidebars_width',
						'priority'        => 10,
						'input_attrs'     => array(
							'min'  => 0,
							'max'  => 100,
			...
			$wp_customize->add_control(
				new HavocWP_Customizer_Radio_Image_Control(
					...
					array(
						'label'    => esc_html__( 'Layout', 'havocwp' ),
						'section'  => 'havoc_ld_layout',
						'settings' => 'havoc_ld_course_layout',
						'priority' => 10,
						'choices'  => havocwp_customizer_layout(),
					)
				)
			 ...
			 */
			$wp_customize->add_setting(
				'havoc_ld_course_both_sidebars_style',
				array(
					'default'           => 'scs-style',
					'sanitize_callback' => 'havocwp_sanitize_select',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'select',
						'section'         => 'havoc_ld_layout',
						'settings'        => 'havoc_ld_course_both_sidebars_style',
						'priority'        => 10,
						'choices'         => array(
							'ssc-style' => esc_html__( 'Sidebar / Sidebar / Content', 'havocwp' ),
							'scs-style' => esc_html__( 'Sidebar / Content / Sidebar', 'havocwp' ),
						...
						'active_callback' => 'havocwp_cac_has_ld_course_bs_layout',
					)
				)
			);
			 ...
			 */
			$wp_customize->add_setting(
				'havoc_ld_course_both_sidebars_content_width',
				array(
					'transport'         => 'postMessage',
					'sanitize_callback' => 'havocwp_sanitize_number_blank',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'number',
						'section'         => 'havoc_ld_layout',
						'settings'        => 'havoc_ld_course_both_sidebars_content_width',
						'priority'        => 10,
						'input_attrs'     => array(
							'min'  => 0,
							'max'  => 100,
			 ...
			 */
			$wp_customize->add_setting(
				'havoc_ld_course_both_sidebars_sidebars_width',
				array(
					'transport'         => 'postMessage',
					'sanitize_callback' => 'havocwp_sanitize_number_blank',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'number',
						'section'         => 'havoc_ld_layout',
						'settings'        => 'havoc_ld_course_both_sidebars_sidebars_width',
						'priority'        => 10,
						'input_attrs'     => array(
							'min'  => 0,
							'max'  => 100,
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'select',
						'section'         => 'havoc_ld_layout',
						'settings'        => 'havoc_ld_course_sidebar_order',
						'priority'        => 10,
						'choices'         => array(
							'content-sidebar' => esc_html__( 'Content / Sidebar', 'havocwp' ),
							'sidebar-content' => esc_html__( 'Sidebar / Content', 'havocwp' ),
						),
						'active_callback' => 'havocwp_cac_has_ld_course_rl_layout',
					)
				)
			);
			...
			$wp_customize->add_control(
				new HavocWP_Customizer_Heading_Control(
					...
					'havoc_ld_lesson_heading',
					array(
						'label'    => esc_html__( 'Lesson/Topic', 'havocwp' ),
						'section'  => 'havoc_ld_layout',
						'priority' => 10,
					)
				)
			...
			$wp_customize->add_control(
				new HavocWP_Customizer_Radio_Image_Control(
					...
					array(
						'label'    => esc_html__( 'Layout', 'havocwp' ),
						'section'  => 'havoc_ld_layout',
						'settings' => 'havoc_ld_lesson_layout',
						'priority' => 10,
						'choices'  => havocwp_customizer_layout(),
					)
				)
			 ...
			 */
			$wp_customize->add_setting(
				'havoc_ld_lesson_both_sidebars_style',
				array(
					'default'           => 'scs-style',
					'sanitize_callback' => 'havocwp_sanitize_select',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'select',
						'section'         => 'havoc_ld_layout',
						'settings'        => 'havoc_ld_lesson_both_sidebars_style',
						'priority'        => 10,
						'choices'         => array(
							'ssc-style' => esc_html__( 'Sidebar / Sidebar / Content', 'havocwp' ),
							'scs-style' => esc_html__( 'Sidebar / Content / Sidebar', 'havocwp' ),
						...
						'active_callback' => 'havocwp_cac_has_ld_lesson_bs_layout',
					)
				)
			);
			 ...
			 */
			$wp_customize->add_setting(
				'havoc_ld_lesson_both_sidebars_content_width',
				array(
					'transport'         => 'postMessage',
					'sanitize_callback' => 'havocwp_sanitize_number_blank',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'number',
						'section'         => 'havoc_ld_layout',
						'settings'        => 'havoc_ld_lesson_both_sidebars_content_width',
						'priority'        => 10,
						'input_attrs'     => array(
							'min'  => 0,
							'max'  => 100,
			 ...
			 */
			$wp_customize->add_setting(
				'havoc_ld_lesson_both_sidebars_sidebars_width',
				array(
					'transport'         => 'postMessage',
					'sanitize_callback' => 'havocwp_sanitize_number_blank',
				)
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'number',
						'section'         => 'havoc_ld_layout',
						'settings'        => 'havoc_ld_lesson_both_sidebars_sidebars_width',
						'priority'        => 10,
						'input_attrs'     => array(
							'min'  => 0,
							'max'  => 100,
			...
			$wp_customize->add_control(
				new WP_Customize_Control(
					...
					array(
						...
						'type'            => 'select',
						'section'         => 'havoc_ld_layout',
						'settings'        => 'havoc_ld_lesson_sidebar_order',
						'priority'        => 10,
						'choices'         => array(
							'content-sidebar' => esc_html__( 'Content / Sidebar', 'havocwp' ),
							'sidebar-content' => esc_html__( 'Sidebar / Content', 'havocwp' ),
						),
						'active_callback' => 'havocwp_cac_has_ld_lesson_rl_layout',
					)
				)
			);
			...
			$wp_customize->add_control(
				new HavocWP_Customizer_Heading_Control(
					...
					'havoc_lld_styling_course',
					array(
						'label'    => esc_html__( 'Table', 'havocwp' ),
						'section'  => 'havoc_ld_styling',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new HavocWP_Customizer_Color_Control(
					...
					'havoc_ld_heading_color',
					array(
						'label'    => esc_html__( 'Heading Color', 'havocwp' ),
						'section'  => 'havoc_ld_styling',
						'settings' => 'havoc_ld_heading_color',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new HavocWP_Customizer_Color_Control(
					...
					'havoc_ld_heading_bg_color',
					array(
						'label'    => esc_html__( 'Heading Background Color', 'havocwp' ),
						'section'  => 'havoc_ld_styling',
						'settings' => 'havoc_ld_heading_bg_color',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new HavocWP_Customizer_Color_Control(
					...
					'havoc_ld_item_color',
					array(
						'label'    => esc_html__( 'Item Color', 'havocwp' ),
						'section'  => 'havoc_ld_styling',
						'settings' => 'havoc_ld_item_color',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new HavocWP_Customizer_Color_Control(
					...
					'havoc_ld_item_hover_color',
					array(
						'label'    => esc_html__( 'Item Hover Color', 'havocwp' ),
						'section'  => 'havoc_ld_styling',
						'settings' => 'havoc_ld_item_hover_color',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new HavocWP_Customizer_Color_Control(
					...
					'havoc_ld_complete_color',
					array(
						'label'    => esc_html__( 'Complete Color', 'havocwp' ),
						'section'  => 'havoc_ld_styling',
						'settings' => 'havoc_ld_complete_color',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new HavocWP_Customizer_Color_Control(
					...
					'havoc_ld_incomplete_color',
					array(
						'label'    => esc_html__( 'Incomplete Color', 'havocwp' ),
						'section'  => 'havoc_ld_styling',
						'settings' => 'havoc_ld_incomplete_color',
						'priority' => 10,
					)
				)
			);
			...
			$wp_customize->add_control(
				new HavocWP_Customizer_Color_Control(
					...
					array(
						...
						'section'  => 'havoc_ld_styling',
						'settings' => 'havoc_ld_progressbar_color',
						'priority' => 10,
					)
				)
			);
		...
		public static function head_css( $output ) {
			...
			// Course Table.
			$heading_color     = get_theme_mod( 'havoc_ld_heading_color' );
			$heading_bg_color  = get_theme_mod( 'havoc_ld_heading_bg_color' );
			$item_color        = get_theme_mod( 'havoc_ld_item_color' );
			$item_hover_color  = get_theme_mod( 'havoc_ld_item_hover_color' );
			$complete_color    = get_theme_mod( 'havoc_ld_complete_color' );
			$incomplete_color  = get_theme_mod( 'havoc_ld_incomplete_color' );
			$progressbar_color = get_theme_mod( 'havoc_ld_progressbar_color' );

			// Both Sidebars - Global.
			$ld_global_layout         = get_theme_mod( 'havoc_ld_global_layout', 'full-width' );
			$bs_global_content_width  = get_theme_mod( 'havoc_ld_global_both_sidebars_content_width' );
			$bs_global_sidebars_width = get_theme_mod( 'havoc_ld_global_both_sidebars_sidebars_width' );

			// Both Sidebars - Course.
			$ld_course_layout         = get_theme_mod( 'havoc_ld_course_layout', 'left-sidebar' );
			$bs_course_content_width  = get_theme_mod( 'havoc_ld_course_both_sidebars_content_width' );
			$bs_course_sidebars_width = get_theme_mod( 'havoc_ld_course_both_sidebars_sidebars_width' );

			// Both Sidebars - Lesson.
			$ld_lesson_layout         = get_theme_mod( 'havoc_ld_lesson_layout', 'left-sidebar' );
			$bs_lesson_content_width  = get_theme_mod( 'havoc_ld_lesson_both_sidebars_content_width' );
			$bs_lesson_sidebars_width = get_theme_mod( 'havoc_ld_lesson_both_sidebars_sidebars_width' );
...
return new HavocWP_LearnDash_Customizer();
