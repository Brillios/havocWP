...
// Heading tag.
$heading = 'h1';
$heading = apply_filters( 'single_havoc_header_7_h_tag', $heading );

// Display meta filter.
$display_sph_meta = true;
$display_sph_meta = apply_filters( 'display_single_havoc_header_7_meta', $display_sph_meta );
...
<div class="havoc-single-post-header single-header-havoc-7 <?php echo esc_attr( $class ); ?>">
	...
	<?php havocwp_paint_post_thumbnail( 'full', array( 'name' => 'havoc-sh-7' ) ); ?>
