...
// Heading tag.
$heading = 'h1';
$heading = apply_filters( 'single_havoc_header_3_h_tag', $heading );

// Display meta filter.
$display_sph_meta = true;
$display_sph_meta = apply_filters( 'display_single_havoc_header_3_meta', $display_sph_meta );

// Display author bio description filter.
$display_author_bio = true;
$display_author_bio = apply_filters( 'display_single_havoc_header_3_author_bio', $display_author_bio );

?>

<div class="havoc-single-post-header single-post-header-wrap single-header-havoc-3">
	<div class="header-overlay-thumbnail" <?php havoc_paint_post_background( 'full' ); ?>></div>
