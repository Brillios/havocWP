...
// Get attachments.
$attachments = havocwp_get_gallery_ids( get_the_ID() );
	...
	<div class="gallery-format clr">
		...
		foreach ( $attachments as $attachment ) :
			...
			if ( HAVOC_EXTRA_ACTIVE
				...
				$attachment_html = '<img src="' . havoc_extra_resize( $img_url[0], $img_atts['width'], $img_atts['height'], $img_atts['crop'], true, $img_atts['upscale'] ) . '" alt="' . $attachment_alt . '" width="' . $img_width . '" height="' . $img_height . '" itemprop="image" />';
			...
			if ( havocwp_gallery_is_lightbox_enabled() ) {
				?>
