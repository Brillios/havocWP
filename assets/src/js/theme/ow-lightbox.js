class OWLightbox {
  ...
  initSingleImageLightbox = () => {
    document.querySelectorAll(".havocwp-lightbox")?.forEach((link) => {
    ...
    jQuery(".havocwp-lightbox").magnificPopup({
      type: "image",
      ...
      ?.forEach((link) => {
        if (!!link.querySelector("img")) {
          ...
          if (
            ...
            link.classList.add("havocwp-lightbox");
          }
...
havocwp.owLightbox = new OWLightbox();
