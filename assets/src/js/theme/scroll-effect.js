...
class ScrollEffect {
  ...
  #setupEventListeners = () => {
    ...
    document.addEventListener('sectionLoaded', () => {
        ...
        if (window.havocwp.fullScreenMobileMenu) {
          window.havocwp.fullScreenMobileMenu.closeMainMenu();
        }

        if (window.havocwp.sidebarMobileMenu) {
          window.havocwp.sidebarMobileMenu.closeSidr();
        }

        if (window.havocwp.dropDownMobileMenu) {
          window.havocwp.dropDownMobileMenu.onMenuCloseClick();
        }
    });
  };
  ...
  !!havocwpLocalize.customScrollOffset ? havocwpLocalize.customScrollOffset : 0;
...
havocwp.scrollEffect = new ScrollEffect();
