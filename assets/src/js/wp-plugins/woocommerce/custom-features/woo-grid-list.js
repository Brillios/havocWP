...
class WooGridList {
  ...
  #setElements = () => {
    this.#elements = {
      ...this.#elements,
      grid: document.querySelector(".havocwp-grid-list #havocwp-grid"),
      list: document.querySelector(".havocwp-grid-list #havocwp-list"),
  ...
  #productCarousel = () => {
    if (
      ...
      havocwp.owSlider.flickity?.forEach((flickity) => {
        flickity.destroy();
      });
    }
