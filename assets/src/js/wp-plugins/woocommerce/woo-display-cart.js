...
class WooDisplayCart {
  ...
  #setElements = () => {
    this.#elements = {
      overlayCart: document.querySelector(".hvc-cart-overlay"),
      body: document.body,
      quickViewModal: document.querySelector("#hvc-qv-wrap"),
      quickViewContent: document.querySelector("#hvc-qv-content"),
